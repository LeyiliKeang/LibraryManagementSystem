...
public class AlterReaderDialog extends JDialog {
    ...
    public AlterReaderDialog() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowOpened(WindowEvent e) {
                AWTUtilities.setWindowOpacity(AlterReaderDialog.this, 0f);
                ActionListener listener = new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        if (alpha < 0.8) {
                            AWTUtilities.setWindowOpacity(AlterReaderDialog.this, alpha += 0.2);
                        } else {
                            AWTUtilities.setWindowOpacity(AlterReaderDialog.this, 1);
    ...
    private void onOK() {
        // add your code here
        if (numberTextField.getText().trim().matches("\\d{14}") && !nameTextField.getText().trim().equals("") && sexComboBox.getSelectedIndex() != -1 && !classTextField.getText().trim().equals("") && phoneTextField.getText().trim().matches("\\d{11}")) {
            ...
            try {
                readerDao.updateReader(reader, Reader.getSelectID());
...
//        AlterReaderDialog dialog = new AlterReaderDialog();
//        dialog.pack();
