    ...
    public AddManagerDialog() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowOpened(WindowEvent e) {
                AWTUtilities.setWindowOpacity(AddManagerDialog.this, 0f);
                ActionListener listener = new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        if (alpha < 0.8) {
                            AWTUtilities.setWindowOpacity(AddManagerDialog.this, alpha += 0.2);
                        } else {
                            AWTUtilities.setWindowOpacity(AddManagerDialog.this, 1);
    ...
    private void onOK() {
        ...
        if (numberTextField.getText().trim().matches("\\d{17}[0-9xX]") && !nameTextField.getText().trim().equals("")
            ...
            try {
                ...
                JOptionPane.showMessageDialog(getContentPane(), "添加成功", "提示", JOptionPane.WARNING_MESSAGE);
                dispose();
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
                JOptionPane.showMessageDialog(getContentPane(), "添加失败", "提示", JOptionPane.WARNING_MESSAGE);
